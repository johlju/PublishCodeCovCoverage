...
import { downloadFile } from '../utils/webUtils.js';
...
describe('webUtils', () => {
    ...
    beforeEach(() => {
        ...
        mockFileStream.close = jest.fn((callback) => {
            if (callback)
                callback();
        });
    ...
    describe('downloadFile', () => {
        test('should ensure parent directory exists before downloading', async () => {
            ...
            const downloadPromise = downloadFile('https://example.com/file.zip', '/path/to/nested/directory/file.zip');
        ...
        test('should handle errors during directory creation', async () => {
            ...
            await expect(downloadFile('https://example.com/file.zip', '/path/to/error/directory/file.zip')).rejects.toThrow("Failed to create directory '/path/to/error/directory': Directory creation failed");
        ...
        test('should download a file successfully', async () => {
            ...
            const downloadPromise = downloadFile('https://example.com/file.zip', '/path/to/destination.zip');
        ...
        test('should handle other 2xx status codes (204 and 206)', async () => {
            ...
            const downloadPromise204 = downloadFile('https://example.com/empty-resource', '/path/to/empty-file');
            // Simulate file stream completion
            setTimeout(() => {
                mockFileStream.emit('finish');
                // Emit close event instead of directly accessing mock.calls
            ...
            const downloadPromise206 = downloadFile('https://example.com/partial-content', '/path/to/partial-file');
            // Simulate data chunks coming in
        ...
        test('should handle progress tracking', async () => {
            ...
            const downloadPromise = downloadFile('https://example.com/file.zip', '/path/to/destination.zip', { onProgress: onProgressMock });
        ...
        test('should handle HTTP error status', async () => {
            ...
            await expect(downloadFile('https://example.com/nonexistent.zip', '/path/to/destination.zip')).rejects.toThrow("Failed to get 'https://example.com/nonexistent.zip' (404)");
        ...
        test('should handle network errors', async () => {
            ...
            // Call downloadFile and expect it to reject
            await expect(downloadFile('https://example.com/file.zip', '/path/to/destination.zip')).rejects.toThrow('Network Error');
        ...
        test('should handle timeout errors', async () => {
            ...
            await expect(downloadFile('https://example.com/file.zip', '/path/to/destination.zip', { timeout: 5000 })).rejects.toThrow('Request timed out after 5000ms');
        ...
        test('should handle aborted requests with ERR_CANCELED code', async () => {
            ...
            const downloadPromise = downloadFile('https://example.com/file.zip', '/path/to/destination.zip', { signal: abortController.signal });
